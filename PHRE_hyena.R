...
##run PHRE
##apply phre function
HR<-phre(locs=locs.utm@coords, rast=rasters, smoother='default', percent=90) ##resolution here is equal to the number of cells across the input raster, so a higher number leads to better resolution; default is 500
